...
public enum OpenhabItem {	
	DIMMER {
		@Override
		public String getOHItemScript(Component com, Property prop, String mqtt_broker, String openhab_topic) {
			String items = "";
	 ...
	 */
	public abstract String getOHItemScript(Component com, Property prop, String mqtt_broker, String openhab_topic);
